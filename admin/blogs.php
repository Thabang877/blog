                ...
                if(isset($_REQUEST['deleteblogpost'])) {
                    if($_REQUEST['deleteblogpost'] == "success") {
                        ...
                        <strong>Success!</strong> Blog Post Deleted.
                            ...
                            <strong>Error!</strong> Blog Post was not deleted due to unexpected error.
                            </div>";
                    }
                }
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="popup-button" onclick="windows.open('../single-blog.php?blog=<?php echo $blogPath; ?>', '_blank');">View</button>
