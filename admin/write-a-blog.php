                                        ...
                                        <form role="form" method="POST" action="includes/add-blog.php"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="blog-title"
                                                    value="<?php if(isset($_SESSION['blogTitle'])) {echo $_SESSION['blogTitle']; } ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Meta Title</label>
                                                <input class="form-control" name="blog-meta-title"
                                                    value="<?php if(isset($_SESSION['blogMetaTitle'])) {echo $_SESSION['blogMetaTitle']; } ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" name="blog-summary"
                                                    <?php if(isset($_SESSION['blogSummary'])) {echo $_SESSION['blogSummary']; } ?>></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Blog Content</label>
                                                <textarea class="form-control" rows="3" name="blog-content" 
                                                id="summernote"<?php if(isset($_SESSION['blogContent'])) {echo $_SESSION['blogContent']; } ?>></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-default" name="submit-blog">Add
                                                Blog</button>
                                        </form>
                                    </div>
                                </div>
