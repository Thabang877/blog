...
if(isset($_REQUEST['blogid'])) {
    ...
    if($rowGetBlockDetails = mysqli_fetch_assoc($queryGetBlogDetails)) {

        $_SESSION['editTitle'] = $rowGetBlockDetails['v_post_title'];
        $_SESSION['editMetaTitle'] = $rowGetBlockDetails['v_post_meta_title'];
        $_SESSION['editCategoryId'] = $rowGetBlockDetails['n_post_category_id'];
        $_SESSION['editSummary'] = $rowGetBlockDetails['v_post_summary'];
        $_SESSION['editContent'] = $rowGetBlockDetails['v_post_content'];
        $_SESSION['editPath'] = $rowGetBlockDetails['v_post_path'];
        $_SESSION['editHomePagePlacement'] = $rowGetBlockDetails['n_home_page_placement'];
    ...
    if($rowGetBlogTags = myqsli_fetch_assoc($queryGetBlogTags)) {
...
<body>
            ...
            <div id="page-inner">
                ...
                if(isset($_REQUEST['updateblog'])){
                    if($_REQUEST['updateblog'] == "emptytitle") {
                        ...
                        echo "<div class='alert alert-danger'>
                            <strong>Error!</strong> Please add block content.
                        ...
                        echo "<div class='alert alert-danger'>
                            <strong>Error!</strong> Main Image -> Upload jpg, jpeg, png, gif, bmp images.
                        
                        </div>";
                    }
                    else if($_REQUEST['updateblog'] == "invalidtypealtimage") {
                        echo "<div class='alert alert-danger'>
                            <strong>Error!</strong> Alt Image -> Upload jpg, jpeg, png, gif, bmp images.
                        ...
                        echo "<div class='alert alert-danger'>
                            <strong>Error!</strong> An unexpected error occurred while trying to set up the home page placement. Please try again.
                                        ...
                                        <form role="form" method="POST" action="includes/update-blog.php"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" name="blog-summary"
                                                    <?php echo $_SESSION['editSummary']; ?>></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Blog Content</label>
                                                <textarea class="form-control" rows="3" name="blog-content"
                                                    <?php echo $_SESSION['editContent']; ?>></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon">www.thabangmodi.com/</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="blog-home-page-placement"
                                                        id="optionsRadiosInline1" value="option1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true">&times;</button>
                                                <h4 class="modal-title" id="myModalLabel">Alternate Image</h4>
                                            </div>
                                            <div class="modal-body">
    ...
    <csript src="https://code.jquery.com/jquery-3.5.1.min.js">
        </script>
        <!-- Bootstrap Js -->
